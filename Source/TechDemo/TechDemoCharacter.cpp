...
void ATechDemoCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ATechDemoCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ATechDemoCharacter::TouchStopped);
...
void ATechDemoCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void ATechDemoCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
